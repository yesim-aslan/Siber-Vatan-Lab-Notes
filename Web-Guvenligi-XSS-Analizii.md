...
### 🔹 C. DOM-Based XSS
Sunucu taraflı değil, tamamen tarayıcıdaki (Client-side) JavaScript kodlarının hatalı işlenmesinden kaynaklanır. Sayfa kaynağı değişmez ama tarayıcıdaki DOM (Document Object Model) yapısı manipüle edilir.
